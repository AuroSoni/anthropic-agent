...
# The AST evaluator can't use Python's native control flow statements directly because it's interpreting rather 
# than executing code. These exceptions allow control flow to propagate up through multiple function calls in the evaluation stack.
